const CACHE_NAME = 'lukfook-smart-quote-demo-v11';
const APP_SHELL = [
  ...
  './assets/js/common.js','./assets/js/region-config.js','./assets/js/overseas-quote.js','./assets/js/smart-quote.js','./assets/js/travel-expense.js'
];
